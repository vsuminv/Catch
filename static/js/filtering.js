...
$(function() {
    ...
    $('.btn_pass').unbind().bind('click', function(){
        ...
        $('.popup_type div.choice_area').append('<label class="select_radiobox style_01 mb10"><input type="radio" name="passType" value="168"/><em></em><span>수시합격</span></label>');
        $('.popup_type div.choice_area').append('<label class="select_radiobox style_01 mb10"><input type="radio" name="passType" value="171"/><em></em><span>정시합격</span></label>');
